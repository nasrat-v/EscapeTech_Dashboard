...
class CoinSensor extends React.Component {
  ...
  fetchTemperature() {
      axios.get(`http://192.168.2.7:3000/getTemperature`)
      .then(res => {
  ...
  fetchHumidity() {
      axios.get(`http://192.168.2.7:3000/getHumidity`)
      .then(res => {
          console.log(res.data);
  ...
  fetchPressure() {
      axios.get(`http://192.168.2.7:3000/getPressure`)
      .then(res => {
          console.log(res.data);
  ...
  fetchMagnetometer() {
      axios.get(`http://192.168.2.7:3000/getMagnetometer`)
      .then(res => {
          console.log(res.data);
  ...
  fetchGyroscope() {
      axios.get(`http://192.168.2.7:3000/getGyroscope`)
      .then(res => {
          console.log(res.data);
  ...
  fetchAccelerometer() {
      axios.get(`http://192.168.2.7:3000/getAccelerometer`)
      .then(res => {
          console.log(res.data);
