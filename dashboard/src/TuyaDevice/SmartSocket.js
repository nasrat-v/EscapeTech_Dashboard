...
class SmartSocket extends React.Component {
  ...
  initSwitchState() {
    axios
      .get(`http://192.168.2.10:3000/getStatusSocket`)
      .then(res => {
  ...
  turnOnSocket() {
    axios
      .get(`http://192.168.2.10:3000/turnOnSocket`)
      .then(res => {
        console.log(res.data);
      })
      .catch(function(err) {
  ...
  turnOffSocket() {
    axios
      .get(`http://192.168.2.10:3000/turnOffSocket`)
      .then(res => {
        console.log(res.data);
      })
      .catch(function(err) {
  ...
  flashSocket() {
    ...
    axios
      .post(`http://192.168.2.10:3000/flashSocket`, { utimer: timer })
      .then(res => {
        console.log(res.data);
      })
      .catch(function(err) {
  ...
  setColorLight(colorString) {
    axios
      .post(`http://192.168.2.10:3000/setColorSocket`, { color: colorString })
      .then(res => {
        console.log(res.data);
      })
      .catch(function(err) {
        ...
        <div className="jumbotron">
          <div className="switch-container">
            <label>
              <input
                ref="switch"
                checked={this.state.isSocketOn}
                onChange={this.handleChangeSocket}
                className="switch"
                type="checkbox"
              />
              <div>
